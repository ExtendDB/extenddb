...
This directory documents the registry-neutral ExtendDB PostgreSQL container
image.
...
* Generated software license notices cover distributed Rust packages. Debian
  package notices remain in `/usr/share/doc/*/copyright` with `dpkg` metadata intact.
